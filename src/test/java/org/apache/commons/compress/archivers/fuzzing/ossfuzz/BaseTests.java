...
public class BaseTests {
    public void fuzzerInitialize() {
        LogManager.getLogManager().reset();
    }

    // Fuzz archiver streams by reading every entry
    public void fuzzArchiveInputStream(ArchiveInputStream is) throws IOException {
        ArchiveEntry entry;
    ...
    public void fuzzCompressorInputStream(CompressorInputStream is) throws IOException {
        is.read(new byte[1024]);
        is.close();
    }
}
