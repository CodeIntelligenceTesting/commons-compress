...
//            assertEquals(entry.getTime(), entry2.getTime());
    ...
    void reproduceFuzzingOOMPack() {
        ...
        // Helper block to transform fuzzer input to JAR input
        ...
        try (//ByteArrayInputStream in = new ByteArrayInputStream(jarBytes);
            ...
            try {
                /*
                 * TODO OOM happens in the pack() method submethod call readJarEntry
                 * at org/apache/commons/compress/harmony/pack200/PackingUtils.java:202
                 * if jarEntry.getSize() returns INTEGER.MAX_VALUE - 1.
                 */
